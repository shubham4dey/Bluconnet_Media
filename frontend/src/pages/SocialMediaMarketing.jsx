...
const SocialMediaMarketing = () => {
  ...
  const services = [
    {
      ...
      desc: "Build a clear social media strategy that connects your brand with the right audience and creates consistent opportunities for growth.",
    },
    {
      icon: FaPalette,
      number: "02",
      title: "Content Creation",
      desc: "Create scroll-stopping visuals, captions, reels and branded content designed to capture attention and strengthen your online presence.",
    },
    {
      icon: FaHashtag,
      number: "03",
      title: "Hashtag & Content Optimization",
      desc: "Use smarter content structures, hashtags and publishing strategies to increase reach, discoverability and engagement.",
    },
    {
      icon: FaComments,
      number: "04",
      title: "Community Engagement",
      desc: "Turn followers into an active community through meaningful conversations, engagement and consistent brand interactions.",
    },
  ];
  ...
  const journey = [
    ...
    },
    {
      icon: FaPalette,
      title: "Engage",
      desc: "Create content people want to interact with.",
    },
    {
      icon: FaHeart,
      title: "Connect",
      desc: "Build stronger relationships with your audience.",
    },
    {
      icon: FaShareAlt,
      title: "Amplify",
      desc: "Turn great content into wider brand exposure.",
    },
    {
      icon: FaChartLine,
      title: "Grow",
      desc: "Convert social attention into business growth.",
    },
  ];
  ...
  const process = [
    {
      ...
      desc: "We study your audience, competitors, industry and existing social presence to identify the strongest opportunities for growth.",
    },
    {
      number: "02",
      icon: FaPalette,
      title: "Content Planning",
      desc: "We build content pillars, creative concepts, captions and publishing plans designed around your brand and audience.",
    },
    {
      number: "03",
      icon: FaRocket,
      title: "Publish & Amplify",
      desc: "Your content goes live consistently across relevant platforms while campaigns are optimized for maximum reach and engagement.",
    },
    {
      number: "04",
      icon: FaChartBar,
      title: "Measure & Optimize",
      desc: "We analyze reach, engagement, audience growth and conversions to continuously improve your social media performance.",
    },
  ];
    ...
    >
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-14 lg:gap-16 xl:gap-24 items-center">
            ...
            >
              ...
              >
                We build powerful social media systems that increase visibility,
                create meaningful engagement and turn followers into loyal
                customers.
              </motion.p>
              ...
              >
                {/* Primary Button: Grow Your Social Presence */}
                <motion.button
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div className="pt-1.5 sm:pt-2">
                    ...
                    >
                      Audience interaction increased
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  <div className="h-28 sm:h-32 md:h-36 flex items-end gap-1.5 sm:gap-2">
                    {[42, 55, 48, 68, 62, 78, 73, 96].map((height, index) => (
                      <motion.div
                        key={index}
                        initial={{
                          height: 0,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[0.75fr_1.25fr] gap-12 lg:gap-20">
            ...
            >
              ...
              >
                We create complete social media systems that build visibility,
                increase engagement and turn your online audience into long-term
                business value.
              </p>
              ...
              >
                ...
                >
                  <FaShareAlt className="text-[#07101a]" />
                </span>
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              Your social media should continuously attract attention, generate
              conversations and create new opportunities for your brand.
            </p>
          </div>
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              We don't chase empty likes. We measure the numbers that actually
              show whether your social presence is growing.
            </p>
          </div>
      ...
      <section className="relative py-24 sm:py-28 md:py-36 px-4 sm:px-6 overflow-hidden">
        ...
        >
          ...
          >
            <FaShareAlt className="text-[#07101a] text-xl sm:text-2xl" />
          </div>
          ...
          >
            Let's build a social media strategy that gets your brand seen,
            creates meaningful conversations and turns attention into measurable
            business growth.
          </p>
...
const FaHeartIcon = () => <span className="text-[#07101a] text-lg">♥</span>;
