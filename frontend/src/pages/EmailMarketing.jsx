  ...
  const services = [
    {
      ...
      desc: "Turn audience data into highly targeted segments and deliver the right message at the right moment.",
    },
    {
      icon: FaRobot,
      number: "02",
      title: "Smart Automation",
      desc: "Build intelligent customer journeys triggered by clicks, purchases, browsing behavior and engagement.",
    },
    {
      icon: FaPalette,
      number: "03",
      title: "Creative That Converts",
      desc: "Beautiful responsive email experiences designed around your brand, audience and conversion goals.",
    },
    {
      icon: FaChartLine,
      number: "04",
      title: "Performance Optimization",
      desc: "Continuously test, measure and improve campaigns so your email channel becomes stronger every month.",
    },
  ];
  ...
  const journey = [
    {
      icon: FaUsers,
      title: "Capture",
      desc: "Turn visitors into subscribers.",
    },
    {
      icon: FaEnvelopeOpenText,
      title: "Welcome",
      desc: "Make a powerful first impression.",
    },
    {
      icon: FaSyncAlt,
      title: "Nurture",
      desc: "Build trust with relevant content.",
    },
    {
      icon: FaMousePointer,
      title: "Convert",
      desc: "Turn engagement into revenue.",
    },
    {
      icon: FaStar,
      title: "Retain",
      desc: "Create loyal repeat customers.",
    },
  ];
  ...
  const process = [
    {
      ...
      desc: "We analyze your audience, existing campaigns, customer journey and current performance.",
    },
    {
      number: "02",
      icon: FaPalette,
      title: "Creative & Copy",
      desc: "Our team develops conversion-focused designs, messaging and campaign concepts.",
    },
    {
      number: "03",
      icon: FaRobot,
      title: "Automation & Launch",
      desc: "We build intelligent flows, triggers and segmentation before launching campaigns.",
    },
    {
      number: "04",
      icon: FaChartLine,
      title: "Test & Scale",
      desc: "We continuously optimize timing, content, subject lines and offers using real data.",
    },
  ];
    ...
    >
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-14 lg:gap-16 xl:gap-24 items-center">
            ...
            >
              ...
              >
                We combine strategy, automation, creative and data to transform
                ordinary email lists into predictable revenue engines.
              </motion.p>
            ...
            {/* =====================================================
                HERO RIGHT — PREMIUM EMAIL DASHBOARD
            ===================================================== */}
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="relative shrink-0">
                    ...
                    >
                      <FaEnvelopeOpenText className="text-[#07101a]" />
                    </div>
                  ...
                  <div>
                    <p
                      className={`text-xs sm:text-sm font-black ${theme.text}`}
                    >
                      Campaign Live
                    </p>
              ...
              >
                ...
                >
                  <div className="flex justify-between items-center mb-5">
                    ...
                    >
                      <FaChartPie className={theme.accent} />
                    </div>
                  </div>

                  <div className="h-28 sm:h-32 md:h-36 flex items-end gap-1.5 sm:gap-2">
                    {[35, 48, 42, 68, 55, 78, 72, 96].map((height, index) => (
                      <motion.div
                        key={index}
                        initial={{
                          height: 0,
      ...
      <section className={`border-y ${theme.border} py-8 sm:py-10`}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            Built for the tools your business already uses
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[0.75fr_1.25fr] gap-12 lg:gap-20">
            ...
            >
              ...
              >
                Every campaign is designed to move your audience closer to
                becoming a customer — and then keep them coming back.
              </p>
              ...
              >
                ...
                <span>Strategy + Creative + Automation</span>
              </div>
            </motion.div>
              ...
              {services.map((service, index) => (
                ...
                >
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <span
                      className={`text-4xl font-black ${isDarkMode ? "text-white/5" : "text-gray-100"}`}
                    >
                      {service.number}
                    </span>
                  </div>
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              Your email database should be working even when your team isn't.
            </p>
          </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="mt-7">
                  ...
                  <div
                    className={`h-2 rounded-full ${isDarkMode ? "bg-white/5" : "bg-gray-100"} overflow-hidden`}
                  >
                    <motion.div
                      initial={{
                        width: 0,
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              We don't guess what works. We measure it, test it and scale it.
            </p>
          </div>
      ...
      <section className="relative py-24 sm:py-28 md:py-36 px-4 sm:px-6 overflow-hidden">
        ...
        >
          ...
          >
            <FaPaperPlane className="text-[#07101a] text-xl sm:text-2xl" />
          </div>
          ...
          >
            Let's turn your existing audience into your most profitable
            marketing channel with a strategy built around your business.
          </p>
