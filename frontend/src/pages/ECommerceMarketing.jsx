  ...
  const services = [
    {
      ...
      desc: "Build a scalable marketing strategy that connects your products with the right shoppers and creates consistent online revenue.",
    },
    {
      icon: FaTags,
      number: "02",
      title: "Product & Offer Optimization",
      desc: "Improve product positioning, offers, pricing and messaging to make your store more attractive and increase purchase intent.",
    },
    {
      icon: FaShoppingCart,
      number: "03",
      title: "Conversion-Focused Store",
      desc: "Create optimized shopping experiences with clear product journeys, compelling CTAs and frictionless checkout flows.",
    },
    {
      icon: FaFilter,
      number: "04",
      title: "Cart & Customer Retargeting",
      desc: "Reconnect with shoppers who viewed products, abandoned carts or interacted with your store but didn't purchase.",
    },
  ];
  ...
  const journey = [
    {
      icon: FaUsers,
      title: "Discover",
      desc: "Reach shoppers actively interested in your products.",
    },
    {
      icon: FaSearch,
      title: "Explore",
      desc: "Guide visitors toward the products they need.",
    },
    {
      icon: FaShoppingCart,
      title: "Add To Cart",
      desc: "Turn product interest into shopping intent.",
    },
    {
      icon: FaCreditCard,
      title: "Purchase",
      desc: "Make checkout simple, fast and frictionless.",
    },
    {
      icon: FaHeart,
      title: "Retain",
      desc: "Turn buyers into repeat and loyal customers.",
    },
  ];
  ...
  const process = [
    {
      ...
      desc: "We analyze your products, customers, competitors and market demand to identify the strongest opportunities for e-commerce growth.",
    },
    {
      number: "02",
      icon: FaPalette,
      title: "Build The Shopping Experience",
      desc: "We optimize product pages, offers, landing pages and shopping journeys to create a smooth path from discovery to checkout.",
    },
    {
      number: "03",
      icon: FaRobot,
      title: "Automate & Launch",
      desc: "From abandoned cart flows to product retargeting, we automate key customer touchpoints to keep your store working around the clock.",
    },
    {
      number: "04",
      icon: FaChartBar,
      title: "Track & Optimize",
      desc: "We continuously analyze revenue, conversion rate, AOV, customer behavior and campaign data to improve overall store performance.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-14 lg:gap-16 xl:gap-24 items-center">
            ...
            >
              ...
              >
                ...
                <span
                  className={`text-transparent bg-clip-text bg-gradient-to-r ${
                    isDarkMode ? "from-[#d4e157] to-[#06b6d4]" : "from-emerald-500 to-cyan-600"
                  }`}
                >
                  Loyal Customers.
                </span>
              ...
              >
                We build high-performance e-commerce marketing systems that
                attract shoppers, increase conversions and turn first-time
...
>
  {/* Primary Button: Grow Your Store */}
  <motion.button
  ...
  <motion.button
    ...
    className={`group relative w-full sm:w-auto px-8 py-4 ${
      ...
      isDarkMode ? "border-white/10 text-white" : "border-gray-200 text-gray-950"
  ...
  >
    ...
    <span className="relative z-20 flex items-center gap-2">
      ...
      See How It Works
            ...
            {/* =====================================================
                HERO RIGHT — E-COMMERCE DASHBOARD
            ===================================================== */}
            ...
            >
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  >
                    <FaShoppingCart className="text-[#07101a]" />
                  </div>
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="relative shrink-0">
                    ...
                    >
                      <FaBoxOpen className="text-[#07101a]" />
                    </div>
      ...
      <section className={`border-y ${theme.border} py-8 sm:py-10`}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            Built for the platforms your store already uses
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[0.75fr_1.25fr] gap-12 lg:gap-20">
            ...
            >
              ...
              >
                We build complete e-commerce growth systems that attract
                shoppers, improve product discovery, increase conversions and
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              Your online store should continuously attract, convert and retain
              customers while your marketing systems work in the background.
            </p>
          </div>
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              We don't chase vanity metrics. We focus on the numbers that
              actually increase revenue, customer value and store profitability.
            </p>
          </div>
      ...
      <section className="relative py-24 sm:py-28 md:py-36 px-4 sm:px-6 overflow-hidden">
        ...
        >
          ...
          >
            Let's build an e-commerce marketing system that consistently brings
            in new shoppers, increases conversions and turns customers into
            repeat buyers.
          </p>
  ...
  className={`group relative w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 sm:px-10 py-4 sm:py-5 rounded-full bg-gradient-to-r ${theme.gradientBg} ${
    isDarkMode ? "text-[#0a0e27]" : "text-white" /* ✅ FIXED: Day mode = white, Night mode = black */
