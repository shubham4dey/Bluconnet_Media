  ...
  const services = [
    {
      icon: FaBullhorn,
      number: "01",
      title: "Mobile Campaign Strategy",
      desc: "Build targeted mobile marketing campaigns designed to reach the right audience, increase engagement and generate measurable results.",
    },
    {
      icon: FaUsers,
      number: "02",
      title: "Audience Targeting",
      desc: "Identify high-value mobile audiences using demographics, interests, behavior and engagement signals to improve campaign performance.",
    },
    {
      icon: FaChartLine,
      number: "03",
      title: "Performance Marketing",
      desc: "Track campaigns across channels and continuously optimize budgets, creatives and targeting to maximize return on investment.",
    },
    {
      icon: FaComments,
      number: "04",
      title: "Mobile Engagement",
      desc: "Create meaningful interactions through mobile-first experiences, messaging, notifications and personalized customer journeys.",
    },
  ];
  ...
  const journey = [
    {
      icon: FaSearch,
      title: "Discover",
      desc: "Understand your audience and marketing goals.",
    },
    {
      icon: FaBullseye,
      title: "Target",
      desc: "Reach the right mobile users.",
    },
    {
      icon: FaBullhorn,
      title: "Engage",
      desc: "Deliver compelling mobile experiences.",
    },
    {
      icon: FaChartLine,
      title: "Optimize",
      desc: "Measure results and improve performance.",
    },
    {
      icon: FaRocket,
      title: "Scale",
      desc: "Grow campaigns with proven strategies.",
    },
  ];
  ...
  const process = [
    {
      ...
      desc: "We understand your target audience, mobile behavior, business objectives and competitive landscape before building your marketing strategy.",
    },
    {
      number: "02",
      icon: FaUsers,
      title: "Audience & Campaign Setup",
      desc: "We define audience segments, campaign objectives, channels and messaging to ensure your marketing reaches the users most likely to convert.",
    },
    {
      number: "03",
      icon: FaBullhorn,
      title: "Launch & Engage",
      desc: "We launch mobile-first campaigns across relevant channels while creating engaging experiences that encourage users to interact with your brand.",
    },
    {
      number: "04",
      icon: FaChartLine,
      title: "Measure & Optimize",
      desc: "We monitor performance, analyze user behavior and continuously optimize campaigns to improve engagement, conversions and overall ROI.",
    },
  ];
    ...
    >
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-14 lg:gap-16 xl:gap-24 items-center">
            ...
            >
              ...
              >
                We create mobile-first marketing strategies that connect your
                brand with the right audience, drive meaningful engagement and
                turn mobile traffic into measurable business growth.
              </motion.p>
            ...
            {/* =====================================================
                HERO RIGHT — MOBILE MARKETING DASHBOARD
            ===================================================== */}
            ...
            >
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  >
                    <FaChartLine className="text-[#07101a]" />
                  </div>
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="relative shrink-0">
                    ...
                    >
                      <FaBullseye className="text-[#07101a]" />
                    </div>
      ...
      <section className={`border-y ${theme.border} py-8 sm:py-10`}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            Built for the mobile channels your audience already uses
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[0.75fr_1.25fr] gap-12 lg:gap-20">
            ...
            >
              ...
              >
                We combine mobile strategy, audience intelligence, creative
                engagement and performance optimization to build campaigns that
                move people and grow businesses.
              </p>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      >
                        <Icon className="text-xl text-[#07101a]" />
                      </div>
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              Your mobile audience generates valuable signals at every stage. We
              connect those signals to create better campaigns, stronger
                  ...
                  {[
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <Icon className="text-[#07101a] text-sm" />
                        </div>
                ...
                <div className="mt-7">
                  <div className="flex justify-between mb-2">
                    <span className={`text-xs ${theme.muted}`}>
                      Campaign optimization progress
                    </span>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-1 gap-5">
              ...
              >
                <div
                  className={`mx-auto w-11 h-11 rounded-xl bg-gradient-to-br ${theme.gradientBg} flex items-center justify-center mb-5`}
                >
                  <FaChartBar className="text-[#07101a]" />
                </div>
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              Every campaign is measured, analyzed and optimized to help your
              business achieve stronger mobile engagement and sustainable
              growth.
            </p>
          </div>
            ...
            {stats.map((stat, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <Icon className="text-[#07101a] text-sm sm:text-base" />
                  </div>
          ...
          <div className="text-center mb-24">
            ...
            >
              <span className="lg:whitespace-nowrap">
                A Mobile Marketing System Built
              </span>
              <br />
              <span
                className={`text-transparent bg-clip-text bg-gradient-to-r ${
              ...
              return (
                ...
                >
                  <div className="flex gap-5">
                    ...
                    >
                      <Icon className="text-[#07101a] text-xl" />
                    </div>
      ...
      <section className="relative py-24 sm:py-28 md:py-36 px-4 sm:px-6 overflow-hidden">
        ...
        >
          ...
          >
            <FaMobileAlt className="text-[#07101a] text-xl sm:text-2xl" />
          </div>
          ...
          >
            Let's build a mobile marketing strategy that reaches the right
            audience, creates meaningful engagement and turns mobile attention
