  ...
  const services = [
    {
      ...
      desc: "Build a scalable affiliate strategy that connects your brand with the right partners, audiences and revenue opportunities.",
    },
    {
      icon: FaUsers,
      number: "02",
      title: "Affiliate Partner Recruitment",
      desc: "Find and attract relevant publishers, creators and affiliates who can promote your products to high-intent audiences.",
    },
    {
      icon: FaBullhorn,
      number: "03",
      title: "Campaign Management",
      desc: "Launch, manage and optimize affiliate campaigns with clear offers, tracking systems and performance-focused promotions.",
    },
    {
      icon: FaChartLine,
      number: "04",
      title: "Performance Optimization",
      desc: "Analyze clicks, conversions, commissions and revenue to continuously improve affiliate performance and ROI.",
    },
  ];
  ...
  const journey = [
    {
      icon: FaSearch,
      title: "Discover",
      desc: "Identify the right products, audiences and affiliate opportunities.",
    },
    {
      icon: FaHandshake,
      title: "Connect",
      desc: "Build partnerships with relevant affiliates and publishers.",
    },
    {
      icon: FaLink,
      title: "Promote",
      desc: "Launch trackable offers, links and promotional campaigns.",
    },
    {
      icon: FaChartLine,
      title: "Optimize",
      desc: "Improve performance using real-time campaign data.",
    },
    {
      icon: FaMoneyBillWave,
      title: "Scale",
      desc: "Grow profitable partnerships and increase affiliate revenue.",
    },
  ];
  ...
  const process = [
    {
      ...
      desc: "We study your products, audience, competitors and market to identify the strongest affiliate opportunities.",
    },
    {
      number: "02",
      icon: FaUsers,
      title: "Build Partner Network",
      desc: "We identify suitable affiliates, creators and publishers who align with your brand and target customers.",
    },
    {
      number: "03",
      icon: FaLink,
      title: "Launch & Track",
      desc: "Campaigns, affiliate links and offers are launched with accurate tracking so every click and conversion can be measured.",
    },
    {
      number: "04",
      icon: FaChartBar,
      title: "Optimize & Scale",
      desc: "We analyze performance and continuously optimize commissions, offers, partners and campaigns to increase revenue.",
    },
  ];
    ...
    >
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-14 lg:gap-16 xl:gap-24 items-center">
            ...
            >
              ...
              >
                We build performance-driven affiliate marketing systems that
                connect your brand with the right partners, increase product
                visibility and turn referrals into measurable revenue.
              </motion.p>
              ...
              >
                {/* Primary Button: Grow Affiliate Revenue */}
                <motion.button
            ...
            {/* =====================================================
                HERO RIGHT — AFFILIATE DASHBOARD
            ===================================================== */}
            ...
            >
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  >
                    <FaMoneyBillWave className="text-[#07101a]" />
                  </div>
      ...
      <section className={`border-y ${theme.border} py-8 sm:py-10`}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            Built for the platforms your affiliate business already uses
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[0.75fr_1.25fr] gap-12 lg:gap-20">
            ...
            >
              ...
              >
                We build complete affiliate ecosystems that connect brands with
                high-performing partners and turn referral traffic into
                consistent revenue.
              </p>
              ...
              >
                ...
                Strategy + Partnerships + Optimization
              </div>
            </motion.div>
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              Turn trusted partnerships into a predictable acquisition channel
              that continuously generates clicks, conversions and revenue.
            </p>
          </div>
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              We don't focus on clicks alone. We measure the metrics that
              actually impact affiliate revenue and partner profitability.
            </p>
          </div>
      ...
      <section className="relative py-24 sm:py-28 md:py-36 px-4 sm:px-6 overflow-hidden">
        ...
        >
          ...
          >
            Let's build an affiliate marketing system that connects your brand
            with the right partners, drives more conversions and turns
            performance marketing into a scalable revenue channel.
          </p>
