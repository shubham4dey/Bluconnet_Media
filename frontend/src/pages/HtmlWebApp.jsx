  ...
  const services = [
    {
      ...
      desc: "Build modern, responsive websites tailored around your brand, business goals and user experience.",
    },
    {
      icon: FaCode,
      number: "02",
      title: "Web Application Development",
      desc: "Create powerful web applications with intuitive interfaces, scalable architecture and smooth interactions.",
    },
    {
      icon: FaPalette,
      number: "03",
      title: "UI/UX & Interface Design",
      desc: "Design clean and engaging digital experiences that make every interaction simple, intuitive and memorable.",
    },
    {
      icon: FaMobileAlt,
      number: "04",
      title: "Responsive Development",
      desc: "Deliver seamless experiences across mobile, tablet, laptop and desktop with responsive-first development.",
    },
  ];
  ...
  const journey = [
    {
      icon: FaSearch,
      title: "Discover",
      desc: "Understand your business, users and technical requirements.",
    },
    {
      icon: FaPalette,
      title: "Design",
      desc: "Create a clear visual direction and user experience.",
    },
    {
      icon: FaCode,
      title: "Develop",
      desc: "Turn the approved design into a fast working product.",
    },
    {
      icon: FaBug,
      title: "Test",
      desc: "Check performance, responsiveness and functionality.",
    },
    {
      icon: FaRocket,
      title: "Launch",
      desc: "Deploy your website or web app and prepare it for growth.",
    },
  ];
  ...
  const process = [
    {
      ...
      desc: "We understand your goals, target users, competitors and technical requirements before development begins.",
    },
    {
      number: "02",
      icon: FaPalette,
      title: "UI/UX & Architecture",
      desc: "We plan the user journey, interface structure and technical architecture for a smooth digital experience.",
    },
    {
      number: "03",
      icon: FaCode,
      title: "Development",
      desc: "Our team transforms the approved experience into a clean, responsive and functional website or web application.",
    },
    {
      number: "04",
      icon: FaSlidersH,
      title: "Test & Optimize",
      desc: "We test functionality, responsiveness, speed and usability before preparing everything for launch.",
    },
  ];
    ...
    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-14 lg:gap-16 xl:gap-24 items-center">
            ...
            >
              ...
              >
                ...
                applications that look exceptional, work seamlessly and help
              ...
              >
                {/* Primary Button: Build Your Website */}
                <motion.button
            ...
            {/* =====================================================
                HERO RIGHT — WEB DEVELOPMENT DASHBOARD
            ===================================================== */}
              ...
              >
                ...
                >
                  ...
                  <div className="h-28 sm:h-32 md:h-36 flex items-end gap-1.5 sm:gap-2">
                    {[42, 58, 48, 70, 63, 82, 76, 96].map((height, index) => (
                      <motion.div
                        key={index}
                        initial={{
                          height: 0,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[0.75fr_1.25fr] gap-12 lg:gap-20">
            ...
            >
              ...
              >
                We create complete digital experiences that combine beautiful
                interfaces, powerful functionality and reliable performance.
              </p>
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              From landing pages to complex web applications, we build digital
              products designed to perform, scale and evolve with your business.
            </p>
          </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-1 gap-5">
              ...
              >
                <div
                  className={`mx-auto w-11 h-11 rounded-xl bg-gradient-to-br ${theme.gradientBg} flex items-center justify-center mb-5`}
                >
                  <FaShieldAlt className="text-[#07101a]" />
                </div>
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              We focus on the metrics that create better experiences, stronger
              engagement and more reliable digital products.
            </p>
          </div>
      ...
      <section className="relative py-24 sm:py-28 md:py-36 px-4 sm:px-6 overflow-hidden">
        ...
        >
          ...
          >
            Let's build a fast, modern and scalable website or web application
            that gives your business a stronger digital presence and a better
