  ...
  const services = [
    {
      ...
      desc: "Collect, organize and structure data from multiple sources into clean, reliable datasets ready for meaningful analysis.",
    },
    {
      icon: FaSearch,
      number: "02",
      title: "Market & Competitor Research",
      desc: "Analyze markets, competitors, customer behavior and industry trends to uncover opportunities and reduce uncertainty.",
    },
    {
      icon: FaChartBar,
      number: "03",
      title: "Business Intelligence",
      desc: "Transform complex datasets into clear dashboards, reports and actionable insights that support smarter decisions.",
    },
    {
      icon: FaBrain,
      number: "04",
      title: "Predictive Insights",
      desc: "Use historical patterns and performance data to identify trends, forecast outcomes and discover future growth opportunities.",
    },
  ];
  ...
  const journey = [
    {
      icon: FaDatabase,
      title: "Collect",
      desc: "Gather data from the right sources.",
    },
    {
      icon: FaFilter,
      title: "Clean",
      desc: "Remove errors and organize datasets.",
    },
    {
      icon: FaChartLine,
      title: "Analyze",
      desc: "Discover patterns and key trends.",
    },
    {
      icon: FaLightbulb,
      title: "Interpret",
      desc: "Turn numbers into meaningful insights.",
    },
    {
      icon: FaBullseye,
      title: "Decide",
      desc: "Use insights to make better decisions.",
    },
  ];
  ...
  const process = [
    {
      ...
      desc: "We understand your business goals, research questions, existing data sources and key performance indicators before beginning the analysis.",
    },
    {
      number: "02",
      icon: FaDatabase,
      title: "Collect & Prepare",
      desc: "We gather relevant information, clean datasets, remove inconsistencies and prepare reliable data for deeper analysis.",
    },
    {
      number: "03",
      icon: FaChartBar,
      title: "Analyze & Visualize",
      desc: "We identify patterns, trends and relationships while transforming complex data into intuitive dashboards and visual reports.",
    },
    {
      number: "04",
      icon: FaLightbulb,
      title: "Insights & Strategy",
      desc: "We translate analytical findings into practical recommendations that help your team improve performance and make confident decisions.",
    },
  ];
    ...
    >
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-14 lg:gap-16 xl:gap-24 items-center">
            ...
            >
              ...
              >
                We transform complex data into clear insights, actionable
                intelligence and research-backed strategies that help businesses
                understand performance and identify their next growth
                opportunity.
              </motion.p>
            ...
            {/* =====================================================
                HERO RIGHT — ANALYTICS DASHBOARD
            ===================================================== */}
      ...
      <section className={`border-y ${theme.border} py-8 sm:py-10`}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            Built for the data tools your business already uses
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[0.75fr_1.25fr] gap-12 lg:gap-20">
            ...
            >
              ...
              >
                We combine research, analytics and business intelligence to turn
                raw information into insights that reveal what is happening, why
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              Every dataset contains signals. Our job is to identify them,
              connect them and turn them into decisions your business can act
              on.
            </p>
          </div>
                ...
                <div className="mt-7">
                  <div className="flex justify-between mb-2">
                    <span className={`text-xs ${theme.muted}`}>
                      Data quality & analysis progress
                    </span>
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              We don't just report numbers. We investigate the story behind the
              data and uncover the insights that can influence your next
              strategic move.
            </p>
          </div>
      ...
      <section className="relative py-24 sm:py-28 md:py-36 px-4 sm:px-6 overflow-hidden">
        ...
        >
          ...
          >
            Let's transform your data and research into clear insights,
            measurable opportunities and a smarter strategy for sustainable
            business growth.
          </p>
...
export default DataAnalyticsResearch;
