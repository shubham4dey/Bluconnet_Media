  ...
  const services = [
    {
      ...
      desc: "Create visually engaging digital experiences with intuitive layouts, clear navigation and user-focused interfaces.",
    },
    {
      icon: FaLaptopCode,
      number: "02",
      title: "Custom Web Development",
      desc: "Build fast, scalable and reliable websites using modern development technologies tailored to your business.",
    },
    {
      icon: FaMobileAlt,
      number: "03",
      title: "Responsive Development",
      desc: "Deliver seamless experiences across mobile, tablet, laptop and desktop devices with responsive layouts.",
    },
    {
      icon: FaRocket,
      number: "04",
      title: "Performance Optimization",
      desc: "Improve loading speed, Core Web Vitals, technical performance and overall website experience.",
    },
  ];
  ...
  const journey = [
    {
      icon: FaSearch,
      title: "Discover",
      desc: "Understand your goals, audience and digital requirements.",
    },
    {
      icon: FaPalette,
      title: "Design",
      desc: "Create a visual system and interface built around your brand.",
    },
    {
      icon: FaCode,
      title: "Develop",
      desc: "Transform approved designs into clean, functional code.",
    },
    {
      icon: FaClipboardCheck,
      title: "Test",
      desc: "Test usability, responsiveness, performance and functionality.",
    },
    {
      icon: FaRocket,
      title: "Launch",
      desc: "Deploy your website and prepare it for real-world growth.",
    },
  ];
  ...
  const process = [
    {
      ...
      desc: "We understand your business, audience, competitors and project requirements before building the digital experience.",
    },
    {
      number: "02",
      icon: FaPalette,
      title: "UI/UX Design",
      desc: "We design intuitive interfaces, user journeys and visual systems that communicate your brand clearly.",
    },
    {
      number: "03",
      icon: FaCode,
      title: "Development",
      desc: "Our development process turns the approved design into a responsive, scalable and functional website.",
    },
    {
      number: "04",
      icon: FaShieldAlt,
      title: "Testing & Launch",
      desc: "We test responsiveness, usability, performance and functionality before deploying the final website.",
    },
  ];
    ...
    >
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-14 lg:gap-16 xl:gap-24 items-center">
            ...
            >
              ...
              >
                We design and develop modern websites that combine beautiful
                interfaces, powerful technology and performance-driven
                experiences to help businesses grow online.
              </motion.p>
            ...
            >
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  >
                    <FaRocket className="text-[#07101a]" />
                  </div>
              ...
              >
                ...
                <div className="relative flex items-center justify-between mb-6">
                  ...
                  <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-2">
                    <span
                      className={`text-[9px] sm:text-[10px] uppercase tracking-widest whitespace-nowrap ${theme.muted}`}
                    >
                ...
                >
                  ...
                  <div className="h-28 sm:h-32 md:h-36 flex items-end gap-1.5 sm:gap-2">
                    {[42, 55, 48, 68, 61, 79, 73, 96].map((height, index) => (
                      <motion.div
                        key={index}
                        initial={{
                          height: 0,
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4">
            {[
              ...
              >
                <technology.icon className={theme.accent} />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[0.75fr_1.25fr] gap-12 lg:gap-20">
            ...
            >
              ...
              >
                We create digital experiences that combine design, technology,
                usability and performance to turn your website into a powerful
                business asset.
              </p>
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              Your website should look great, load quickly and guide visitors
          ...
          <div className="grid lg:grid-cols-3 gap-5">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {[
                    ...
                    <motion.div
                      ...
                      className={`relative rounded-2xl border ${theme.border} ${theme.inner} p-4 text-center`}
                    >
                      <div
            ...
            <div className="grid grid-cols-2 lg:grid-cols-1 gap-5">
              <motion.div
                ...
                className={`rounded-[1.75rem] border ${theme.border} ${theme.card} p-5 sm:p-7 text-center`}
              >
                <div
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              We focus on the metrics that make websites faster, easier to use
              and more effective.
            </p>
          </div>
      ...
      <section className="relative py-24 sm:py-28 md:py-36 px-4 sm:px-6 overflow-hidden">
        ...
        >
          ...
          >
            <FaLaptopCode className="text-[#07101a] text-xl sm:text-2xl" />
          </div>
          ...
          >
            Let's build a website that looks exceptional, performs beautifully
            and gives your business a stronger digital presence.
          </p>
