  ...
  const services = [
    {
      ...
      desc: "Discover high-value search opportunities and build a keyword strategy focused on relevant traffic, intent and business growth.",
    },
    {
      icon: FaFileAlt,
      number: "02",
      title: "On-Page SEO",
      desc: "Optimize pages, headings, metadata, content structure and internal links to make your website easier to understand and rank.",
    },
    {
      icon: FaLink,
      number: "03",
      title: "Authority & Link Building",
      desc: "Strengthen your website authority with strategic link-building and digital PR opportunities designed to improve search visibility.",
    },
    {
      icon: FaTachometerAlt,
      number: "04",
      title: "Technical SEO",
      desc: "Improve crawlability, indexing, Core Web Vitals, site structure and technical performance for a healthier search presence.",
    },
  ];
  ...
  const journey = [
    {
      icon: FaSearch,
      title: "Discover",
      desc: "Find the keywords and opportunities that matter.",
    },
    {
      icon: FaCode,
      title: "Optimize",
      desc: "Improve your website structure and content.",
    },
    {
      icon: FaLink,
      title: "Build Authority",
      desc: "Grow trust through quality links and mentions.",
    },
    {
      icon: FaChartLine,
      title: "Rank",
      desc: "Increase visibility for valuable searches.",
    },
    {
      icon: FaUsers,
      title: "Grow",
      desc: "Turn organic traffic into business opportunities.",
    },
  ];
  ...
  const process = [
    {
      ...
      desc: "We analyze your website, competitors, keywords, technical health and search landscape to identify the biggest opportunities.",
    },
    {
      number: "02",
      icon: FaSlidersH,
      title: "Strategy & Optimization",
      desc: "We build a practical SEO roadmap covering content, on-page optimization, technical improvements and search intent.",
    },
    {
      number: "03",
      icon: FaLink,
      title: "Authority & Content",
      desc: "We strengthen your website with useful content, internal linking and authority-building strategies that support long-term rankings.",
    },
    {
      number: "04",
      icon: FaChartBar,
      title: "Measure & Scale",
      desc: "We monitor rankings, traffic, conversions and search visibility to continuously improve performance and scale what works.",
    },
  ];
    ...
    >
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-14 lg:gap-16 xl:gap-24 items-center">
            ...
            >
              ...
              >
                We build data-driven SEO strategies that improve search
                visibility, attract high-intent visitors and turn organic
              ...
              >
                {/* Primary Button: Improve My Rankings */}
                <motion.button
                ...
                {/* Secondary Button: See How SEO Works */}
                <motion.button
                  whileHover={{ scale: 1.05, y: -4 }}
                  whileTap={{ scale: 0.95 }}
            ...
            >
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  >
                    <FaSearch className="text-[#07101a]" />
                  </div>
              ...
              >
                ...
                >
                  ...
                  <div className="h-28 sm:h-32 md:h-36 flex items-end gap-1.5 sm:gap-2">
                    {[35, 48, 43, 61, 57, 73, 82, 96].map((height, index) => (
                      <motion.div
                        key={index}
                        initial={{
                          height: 0,
      ...
      <section className={`border-y ${theme.border} py-8 sm:py-10`}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            SEO powered by the tools your business already uses
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[0.75fr_1.25fr] gap-12 lg:gap-20">
            ...
            >
              ...
              >
                We create complete SEO systems that improve technical health,
                strengthen authority, target valuable searches and bring
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              Your SEO system should continuously discover new keywords, improve
              visibility and bring qualified visitors to your website.
            </p>
          </div>
                ...
                <div className="mt-7">
                  <div className="flex justify-between mb-2">
                    <span className={`text-xs ${theme.muted}`}>
                      SEO health & optimization progress
                    </span>
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              We don't chase vanity rankings. We focus on search visibility,
              qualified traffic and metrics that contribute to real business
              growth.
            </p>
          </div>
      ...
      <section className="relative py-24 sm:py-28 md:py-36 px-4 sm:px-6 overflow-hidden">
        ...
        >
          ...
          >
            Let's build an SEO strategy that increases your search visibility,
            attracts qualified visitors and turns organic traffic into
