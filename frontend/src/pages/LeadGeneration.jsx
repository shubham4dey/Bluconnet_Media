  ...
  const services = [
    {
      ...
      desc: "Build a clear acquisition strategy designed to attract the right audience and turn traffic into measurable opportunities.",
    },
    {
      icon: FaMagnet,
      number: "02",
      title: "Lead Magnets That Convert",
      desc: "Create compelling offers, resources and incentives that give your audience a reason to share their information.",
    },
    {
      icon: FaPalette,
      number: "03",
      title: "Conversion-Focused Landing Pages",
      desc: "Design high-converting landing experiences built around strong messaging, clear CTAs and frictionless lead capture.",
    },
    {
      icon: FaFilter,
      number: "04",
      title: "Lead Qualification",
      desc: "Separate high-intent prospects from low-quality leads with smart qualification, segmentation and scoring systems.",
    },
  ];
  ...
  const journey = [
    {
      icon: FaUsers,
      title: "Attract",
      desc: "Bring the right audience to your offer.",
    },
    {
      icon: FaMagnet,
      title: "Capture",
      desc: "Turn visitors into identifiable leads.",
    },
    {
      icon: FaFilter,
      title: "Qualify",
      desc: "Identify prospects with real buying intent.",
    },
    {
      icon: FaSyncAlt,
      title: "Nurture",
      desc: "Build trust until they are ready.",
    },
    {
      icon: FaChartLine,
      title: "Convert",
      desc: "Turn qualified leads into customers.",
    },
  ];
  ...
  const process = [
    {
      ...
      desc: "We analyze your market, audience, competitors and existing acquisition channels to find the strongest lead opportunities.",
    },
    {
      number: "02",
      icon: FaPalette,
      title: "Build The Funnel",
      desc: "We create landing pages, lead magnets, forms and conversion experiences designed to capture high-intent prospects.",
    },
    {
      number: "03",
      icon: FaRobot,
      title: "Automate & Launch",
      desc: "Leads are routed, segmented and nurtured automatically so your sales team can focus on the opportunities that matter.",
    },
    {
      number: "04",
      icon: FaChartBar,
      title: "Test & Optimize",
      desc: "We continuously improve campaigns, landing pages, offers and targeting using real conversion data.",
    },
  ];
    ...
    >
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-14 lg:gap-16 xl:gap-24 items-center">
            ...
            >
              ...
              >
                We build intelligent lead generation systems that attract the
                right audience, capture high-intent prospects and turn attention
            ...
            >
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  >
                    <FaUserPlus className="text-[#07101a]" />
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[0.75fr_1.25fr] gap-12 lg:gap-20">
            ...
            >
              ...
              >
                We build complete acquisition systems that attract the right
                prospects, capture their attention and move them closer to a
                buying decision.
              </p>
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              Your acquisition system should keep finding and qualifying new
              opportunities even when your team isn't working.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              ...
              actually move your pipeline forward.
            </p>
          </div>
      ...
      <section className="relative py-24 sm:py-28 md:py-36 px-4 sm:px-6 overflow-hidden">
        ...
        >
          ...
          >
            Let's build a lead generation system that consistently brings in
            qualified prospects and turns your marketing into a predictable
            growth engine.
          </p>
