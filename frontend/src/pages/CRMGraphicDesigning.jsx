  ...
  const services = [
    {
      ...
      desc: "Organize your customer data, sales pipeline and communication workflows into one streamlined CRM system.",
    },
    {
      icon: FaCogs,
      number: "02",
      title: "CRM Automation",
      desc: "Automate follow-ups, lead assignment, customer updates and repetitive tasks so your team can work smarter.",
    },
    {
      icon: FaPalette,
      number: "03",
      title: "Creative Graphic Design",
      desc: "Create polished visual assets, social creatives, banners and marketing materials that strengthen your brand.",
    },
    {
      icon: FaLayerGroup,
      number: "04",
      title: "Brand Design Systems",
      desc: "Build consistent visual systems with reusable layouts, typography, graphics and branded creative assets.",
    },
  ];
  ...
  const journey = [
    {
      icon: FaSearch,
      title: "Discover",
      desc: "Understand your customers, brand and business workflow.",
    },
    {
      icon: FaDatabase,
      title: "Organize",
      desc: "Structure customer data and creative requirements.",
    },
    {
      icon: FaCogs,
      title: "Automate",
      desc: "Connect workflows and reduce repetitive manual work.",
    },
    {
      icon: FaPalette,
      title: "Design",
      desc: "Create engaging visuals aligned with your brand.",
    },
    {
      icon: FaChartLine,
      title: "Optimize",
      desc: "Improve workflows, campaigns and customer experiences.",
    },
  ];
  ...
  const process = [
    {
      ...
      desc: "We analyze your existing CRM, customer journey, brand identity and creative requirements to build the right strategy.",
    },
    {
      number: "02",
      icon: FaDatabase,
      title: "Organize The System",
      desc: "We structure customer records, pipelines, segments and workflows so your team always knows what happens next.",
    },
    {
      number: "03",
      icon: FaCogs,
      title: "Automate & Design",
      desc: "We automate repetitive CRM tasks while creating professional graphics and visual assets for your marketing needs.",
    },
    {
      number: "04",
      icon: FaChartBar,
      title: "Track & Improve",
      desc: "We monitor workflow performance, customer activity and creative effectiveness to continuously improve your system.",
    },
  ];
    ...
    >
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] gap-14 lg:gap-16 xl:gap-24 items-center">
            ...
            >
              ...
              >
                We combine smart CRM systems with professional graphic design to
                organize customer relationships, automate workflows and create
                visuals that make your brand stand out.
              </motion.p>
              ...
              >
                {/* Primary Button: Improve Your CRM */}
                <motion.button
            ...
            {/* =====================================================
                HERO RIGHT — CRM & DESIGN DASHBOARD
            ===================================================== */}
            ...
            >
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  >
                    <FaDatabase className="text-[#07101a]" />
                  </div>
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="relative shrink-0">
                    ...
                    >
                      <FaPalette className="text-[#07101a]" />
                    </div>
              ...
              >
                ...
                >
                  ...
                  <div className="h-28 sm:h-32 md:h-36 flex items-end gap-1.5 sm:gap-2">
                    {[42, 55, 49, 67, 61, 78, 74, 94].map((height, index) => (
                      <motion.div
                        key={index}
                        initial={{
                          height: 0,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[0.75fr_1.25fr] gap-12 lg:gap-20">
            ...
            >
              ...
              >
                We connect customer management with creative design to give your
                business a more organized workflow and a stronger visual
                presence.
              </p>
              ...
              >
                ...
                >
                  <FaLayerGroup className="text-[#07101a]" />
                </span>
                CRM + Automation + Creative Design
              </div>
            </motion.div>
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              Keep your customer data organized, automate important workflows
              and deliver consistent creative experiences across every channel.
            </p>
          </div>
                ...
                <div className="mt-7">
                  <div className="flex justify-between mb-2">
                    <span className={`text-xs ${theme.muted}`}>
                      Workflow optimization progress
                    </span>
      ...
      <section className="py-24 sm:py-28 md:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            ...
            >
              We measure customer activity, workflow efficiency and creative
              output to make your entire business process more effective.
            </p>
          </div>
      ...
      <section className="relative py-24 sm:py-28 md:py-36 px-4 sm:px-6 overflow-hidden">
        ...
        >
          ...
          >
            Let's build a smarter CRM workflow and a stronger visual identity
            that keeps your team organized, your customers engaged and your
            brand consistently memorable.
          </p>
          ...
          >
            ...
            <span className="relative z-20 flex items-center gap-3">
              Build A Smarter Business System
              <FaArrowRight className="group-hover:translate-x-1 transition-transform duration-300" />
            </span>
          </motion.button>
...
export default CRMGraphicDesigning;
